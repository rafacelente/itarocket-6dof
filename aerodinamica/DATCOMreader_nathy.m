function [CN,CM,CA,CY,CLN,CLL,CL,CD,XCP,CNA,CMA,CYB,CLNB,CLLB,CNQ, CMQ, CAQ, CNAD, CMAD, CYR, CLNR, CLLR, CYP, CLNP ,CLLP, hinge] = DATCOMreader_nathy(caso,FINSET1,FINSET2,dados)
